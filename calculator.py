...
class Equation:
    ...
    def __init__(self, raw_eq: str, initial: bool = False) -> None:
        ...
        - Time Complexity: O(l*m), where l is the length of the equation and m is the amount of negatives in the equation.
    ...
    def __validate(self) -> None:
        ...
        - Raises (ValueError): If equation is invalid.
        - Time Complexity: O(l*m), where l is the length of the equation and m is the amount of negatives in the equation.
    ...
    def __find_pair(self) -> "tuple[int, int]":
        ...
        - Returns (tuple[int, int]): First element is the index of the opening bracket and the second is the index of the closing bracket. 
        - Time Complexity: O(l), where l is the length of the equation.
        - Aux space complexity: O(1).
        """
    ...
    def __solve_basic(self, symbol: str) -> Union[float, int]:
        ...
        - Returns (Union[float, int]): The solution to the equation.
        - Time Complexity: O(l + c*s), where l is the length of the equation, c symbol count and s is the complexity of the `solve` function.
        - Aux space complexity: O(l + c*s).
        """
    ...
    def solve(self) -> Union[float, int]:
        ...
        Solve the equation.
        - Returns (Union[float, int]): The solution to the equation.
        - Time Complexity: O(l*(c+p)), where l is the length of the equation, c is the amount of symbols, and p is the amount of bracket pairs.
        - Aux space complexity: O(l*(c+p)).
        """
